...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarsDefault">
    	...
    	<ul class="navbar-nav ml-auto align-items-center">
    		...
    		<li class="nav-item">
    		<a class="nav-link" href="author.php"><img class="rounded-circle mr-2" src="assets/img/av.png" width="30"><span class="align-middle">Author</span></a>
    		</li>
    ...
    <footer class="footer pt-5 pb-5 text-center">
          ...
          <p>©  <span class="credits font-weight-bold">        
            <a target="_blank" class="text-dark" href=><u>H & D TEMPLATE FOTO </u> by FOTOHD.net.</a>
          </span>
          </p>
