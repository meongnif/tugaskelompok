...
<head>
	...
	<link rel="icon" type="image/jpg" href="assets/img/hd.jpg">
</head>
		...
		<div class="container h-100">
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper">
					<div class="brand">
						<img src="assets/img/hd.jpg" alt="logo">
					</div>
					<div class="card fat">
                        <div class="card-body">
                            ...
                            <form action="aksi_register.php" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama" requierd>
                                 </div>
                                 <div class="form group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="email" requierd>
                                 </div>
                                 <div class="form-group">
                                    <label for="username">Username</label>
                                    <input type="username" class="form-control" name="username" requierd>
                                 </div>
                                 <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="namafoto_pro" requierd>
                                 </div>
